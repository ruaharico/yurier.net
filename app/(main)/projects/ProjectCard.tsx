...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      <p className="pointer-events-none relative z-40 mt-6 flex items-center text-sm font-medium text-zinc-400 transition group-hover:-translate-y-0.5 group-hover:text-[#45c2ff] dark:text-zinc-200 dark:group-hover:text-[#45c2ff]">
